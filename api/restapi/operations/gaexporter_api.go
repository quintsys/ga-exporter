...
func NewGaexporterAPI(spec *loads.Document) *GaexporterAPI {
	return &GaexporterAPI{
		...
		VisitorsVisitorListHandler: visitors.VisitorListHandlerFunc(func(params visitors.VisitorListParams) middleware.Responder {
			return middleware.NotImplemented("operation visitors.VisitorList has not yet been implemented")
		}),
	}
}
...
type GaexporterAPI struct {
	...
	// VisitorsVisitorListHandler sets the operation handler for the visitor list operation
	VisitorsVisitorListHandler visitors.VisitorListHandler
...
func (o *GaexporterAPI) Validate() error {
	...
	if o.VisitorsVisitorListHandler == nil {
		unregistered = append(unregistered, "visitors.VisitorListHandler")
	}
...
func (o *GaexporterAPI) initHandlerCache() {
	...
	o.handlers["GET"][""] = visitors.NewVisitorList(o.context, o.VisitorsVisitorListHandler)
}
